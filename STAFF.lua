   ...
   PlatformHolderFour.CFrame = Base.CFrame * CFrame.new(18, 12.5, 22.5)
	...
	RunService.RenderStepped:Connect(function()
        pcall(function()
            ...
            local RPos = CCent - Players:FindFirstChild(getgenv().TrappedPlayer).Character.HumanoidRootPart.Position
            ...
            if CDist > MDist then
                ...
                Players:FindFirstChild(getgenv().TrappedPlayer).Character.HumanoidRootPart.CFrame = CFrame.new(NPos)
            end
        end)
		pcall(function()
