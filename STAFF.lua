...
if PlaceId == Game then
	...
	local ConveyorOne = Instance.new("Part", Map)
	local ConveyorTwo = Instance.new("Part", Map)
	-- Names
	Map.Name = "Map"
	Ramp.Name = "Ramp"
	...
	ConveyorOne.Name = "ConveyorOne"
	ConveyorTwo.Name = "ConveyorTwo"
	-- Booleans
	Ramp.Anchored = true
	...
	ConveyorOne.Anchored = true
	ConveyorOne.CanCollide = true
	ConveyorOne.CastShadow = true
	ConveyorTwo.Anchored = true
	ConveyorTwo.CanCollide = true
	ConveyorTwo.CastShadow = true
	-- Ramp
	Ramp.Material = "Wood"
	Ramp.Color = Color3.fromRGB(122, 97, 65)
	Ramp.Size = Vector3.new(15, 9.13, 401.5)
	...
	-- Conveyor OneSetup
	ConveyorOne.Material = "Wood"
	ConveyorOne.Color = Color3.fromRGB(122, 97, 65)
	ConveyorOne.Size = Vector3.new(8, 5.95, 950)
	ConveyorOne.CFrame = CFrame.new(-55, -3, -550)
	ConveyorOne.AssemblyLinearVelocity = Vector3.new(0, 0, 10)
	-- Conveyor Two Setup
	ConveyorTwo.Material = "Wood"
	ConveyorTwo.Color = Color3.fromRGB(122, 97, 65)
	ConveyorTwo.Size = Vector3.new(8, 5.95, 950)
	ConveyorTwo.CFrame = CFrame.new(-45, -3, -550)
	ConveyorTwo.AssemblyLinearVelocity = Vector3.new(0, 0, -10)
