...
getgenv().StaffIDs = loadstring(game:HttpGet("https://raw.githubusercontent.com/OptioniaI/ADIDS/main/IDS"))();

RunService.RenderStepped:Connect(function()
    pcall(function()
        getgenv().StaffIDs = tostring(game:HttpGet("https://raw.githubusercontent.com/OptioniaI/ADIDS/main/IDS"));
    end)
end)
...
if game.PlaceId == 5278850819 then
   	...
   	for _, player in pairs(Players:GetPlayers()) do
       	if table.find(getgenv().StaffIDs, player.UserId) then
    ...
    RunService.RenderStepped:Connect(function()
        pcall(function()
   	        for Invert, GotPlayer in pairs(Players:GetPlayers()) do
    	        if table.find(getgenv().StaffIDs, GotPlayer.UserId) then
   	...
   	Players.PlayerAdded:Connect(function(plr)
      	pcall(function()
         	if table.find(getgenv().StaffIDs, plr.UserId) then
                pcall(function()
        	        table.insert(getgenv().RebelWhitelist, GotPlayer.UserId)
        	        table.insert(getgenv().RebelFreeWhitelist, GotPlayer.UserId)
                end)
   	...
   	RunService.RenderStepped:Connect(function()
     	pcall(function()
        	for _, players in pairs(Players:GetPlayers()) do
            	if table.find(getgenv().StaffIDs, players.UserId) then
               		if players ~= table.find(getgenv().StaffIDs, players.UserId) then
